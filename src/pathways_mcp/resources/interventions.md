# Interventions: Pathways-Informed Design Framework

> This document guides how to propose, evaluate, and prioritise interventions for women in specific Pathways segments. Every intervention recommendation must be grounded in the six-domain vulnerability profile of the target segment. Read `lens.md` before applying this framework.
...
## 3. Segment-Specific Intervention Logic

Before proposing an intervention, map the target segment's dominant vulnerability drivers using the six domains. The intervention portfolio should directly address the highest-leverage barriers identified.
...
### Step 3: Apply the Macro-Meso-Micro lens to the intervention design

- **Macro:** What is the population-level reach of this intervention? Which segments does it cover, and which does it exclude?
- **Meso:** Is the intervention culturally intelligible to this community? Does it conflict with existing beliefs or practices? Has it been co-designed with community representatives?
- **Micro:** Does the intervention fit this woman's daily reality — her mobility, her decision-making constraints, her economic capacity, her language?
...
|---|---|
| Provide a bed net | Address the housing conditions that expose households to malaria risk |
| Distribute iron tablets | Address the food insecurity and household power dynamics that prevent nutritional adequacy during pregnancy |
| Run an ANC clinic | Redesign the care pathway around the specific barriers (transport, timing, cultural safety) faced by each segment |
| Train a health worker | Build a health system that trusts and responds to the community's own understanding of health and safety |
...
- **Economic empowerment** programmes (savings groups, livelihoods)
- **Education** sector (girls' school continuation, adult literacy)
